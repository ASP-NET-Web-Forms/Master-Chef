...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox ID="RecipeDescription" style="resize: vertical" TextMode="multiline" Columns="30" Rows="5" runat="server" CssClass="form-control" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RegularExpressionValidator runat="server" ValidationExpression="(([[A-Z]\w+)( \w+)*, [0-9]+])+" ControlToValidate="RecipeIngredients"
